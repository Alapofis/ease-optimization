...
def main():
    ...
    parser.add_argument("--config", default="experiments/configs/epsilon_sweep_m2.yaml")
    ...
    if args.dry_run:
        ...
        sweep_cfg["sweep"]["epsilon"] = [1.0e-2]
    ...
    out_path = ensure_output_dir(base) / "epsilon_sweep.csv"

    for eps in sweep_cfg["sweep"]["epsilon"]:
